...
const messages = {
  ...
  'ja-jp': {
    ...
    next: '次の曲',
    prev: '前の曲',
    hide_win_main: 'メイン画面を隠す',
    show_win_main: 'メイン画面を表示',
    hide_win_lyric: '歌詞ウィンドウを閉じる',
    show_win_lyric: '歌詞ウィンドウを開く',
    lock_win_lyric: '歌詞ウィンドウをロック',
    unlock_win_lyric: '歌詞ウィンドウを解除',
    top_win_lyric: '歌詞を最前面に',
    untop_win_lyric: '最前面を解除',
    show_statusbar_lyric: 'ステータスバーに歌詞を表示',
    hide_statusbar_lyric: 'ステータスバーの歌詞を非表示',
    exit: '終了',
    music_name: 'タイトル: ',
    music_singer: 'アーティスト: ',
  },
