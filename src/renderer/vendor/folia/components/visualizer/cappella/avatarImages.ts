...
// LX Music is bundled with Webpack rather than Vite. The original built-in
// avatar registry uses import.meta.glob; use the album cover or a user-provided
// image instead of creating a second asset registry here.
export const builtinAvatarImages: CappellaAvatarImage[] = [];
