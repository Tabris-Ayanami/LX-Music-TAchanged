...
// The upstream Vite build discovers this asset pack through import.meta.glob.
// LX Music leaves it empty and keeps the public custom-image input supported.
const builtinEmoImages: CappellaEmojiImage[] = [];
