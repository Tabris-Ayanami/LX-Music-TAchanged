...
export default (setting: any): Partial<LX.AppSetting> => {
  ...
  if (compareVer(setting.version, '2.0.0') < 0) {
    ...
    setting['playDetail.immersiveAudioVisualization'] = setting.playDetail?.immersiveAudioVisualization
    setting['playDetail.immersiveAudioVisualizationHeight'] = setting.playDetail?.immersiveAudioVisualizationHeight
    setting['playDetail.immersiveAudioVisualizationStyle'] = setting.playDetail?.immersiveAudioVisualizationStyle
    setting['playDetail.immersiveMvSource'] = setting.playDetail?.immersiveMvSource
    setting['playDetail.immersiveLyricSource'] = setting.playDetail?.immersiveLyricSource
    setting['playDetail.immersiveBackground'] = setting.playDetail?.immersiveBackground
    setting['playDetail.immersiveBackgroundBlur'] = setting.playDetail?.immersiveBackgroundBlur
    setting['playDetail.immersiveControlHideDelay'] = setting.playDetail?.immersiveControlHideDelay
    setting['playDetail.background'] = setting.playDetail?.background
    setting['playDetail.backgroundBlur'] = setting.playDetail?.backgroundBlur
    setting['playDetail.layoutStyle'] = setting.playDetail?.layoutStyle
