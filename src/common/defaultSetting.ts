...
const baseDefaultSetting: LX.AppSetting = {
  ...
  'playDetail.amll.alignPosition': 0.5,
  'playDetail.amll.enableBlur': true,
  'playDetail.amll.enableSpring': true,
  'playDetail.amll.alignAnchor': 'center',
  'playDetail.immersiveEffect': 'classic',
  'playDetail.immersiveAudioVisualization': false,
  'playDetail.immersiveAudioVisualizationHeight': 112,
  'playDetail.immersiveAudioVisualizationStyle': 'wave',
  'playDetail.immersiveMvSource': 'auto',
  'playDetail.immersiveLyricSource': 'auto',
  'playDetail.immersiveBackground': 'aura',
  'playDetail.immersiveBackgroundBlur': 32,
  'playDetail.immersiveControlHideDelay': 3,
